System.register(["@angular/core", "@angular/router", "./not-found/not-found.component", "./StartPage/startpage.component", "./admin/admin-login.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, not_found_component_1, startpage_component_1, admin_login_component_1, routes, AppRoutingModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            exports_1("routes", routes = [
                ...
                { path: 'login', component: startpage_component_1.StartPageComponent },
                { path: 'admin', component: admin_login_component_1.AdminLoginComponent },
                {
                    path: 'adminHome',
