System.register(["@angular/core", "./sport-event.service", "@angular/router", "@angular/platform-browser"], function (exports_1, context_1) {
    ...
    var core_1, sport_event_service_1, router_1, platform_browser_1, CreatedSportEventComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            CreatedSportEventComponent = class CreatedSportEventComponent {
                ...
                getAPage() {
                    this.sportEventService.getSportEventCreatedByPage(6, this.pageNumber, localStorage.getItem('id_token')).then(sEv => {
            ...
            CreatedSportEventComponent = __decorate([
                core_1.Component({
                    styles: [
                        `.search-results {
            height: 50rem;
            ...
            ], CreatedSportEventComponent);
            exports_1("CreatedSportEventComponent", CreatedSportEventComponent);
        }
    };
});
//# sourceMappingURL=sport-event.created.component.js.map